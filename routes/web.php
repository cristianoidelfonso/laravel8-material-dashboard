...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('documentos/management', [App\Http\Controllers\DocumentoController::class, 'management'])->name('documentos.management');
	Route::resource('admin', 'App\Http\Controllers\AdminController', ['except' => ['show']]);
	Route::resource('documentos', 'App\Http\Controllers\DocumentoController', ['except' => ['show']]);
});
